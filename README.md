# **PubSubModelSync**
![Rails badge](https://img.shields.io/badge/Rails-7+-success.png)
![Ruby badge](https://img.shields.io/badge/Ruby-3.2+-success.png)
![Production badge](https://img.shields.io/badge/Production-ready-success.png)

> **This is the Buddy & Selly fork of [owen2345/pub_sub_model_sync](https://github.com/owen2345/pub_sub_model_sync).**
> It is upstream 1.9.3 with the Google transport rewritten against the
> **google-cloud-pubsub 3.x** client, which reorganised the API upstream still
> calls (`Google::Cloud::PubSub.new(project:)`, `client.topic`,
> `Topic#publish_async`). Only the transport differs: the wire format still
> comes from `ServiceBase`, so notifications stay compatible with applications
> running the older client. Install it from this repository:
>
> ```ruby
> gem 'pub_sub_model_sync', github: 'BuddyandSelly/pub_sub_model_sync'
> ```
